<template>
  <nm-box class="nm-mpest-latest" page header footer footer-align="center" no-padding>
...
const { queryLatestSelect } = $api.personnelFiles.employee
export default {
  ...
  methods: {
    query() {
      queryLatestSelect({ page: this.page, name: this.keyword }).then(data => {
